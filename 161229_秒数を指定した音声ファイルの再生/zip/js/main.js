	...
	(function(){
		...
		window.HH_WriteSampleForJavaScript = function(script){
			try{
				...
				//document.write("<div class=\"js_sample_head\">ヘッダに表示するテキスト</div>");
